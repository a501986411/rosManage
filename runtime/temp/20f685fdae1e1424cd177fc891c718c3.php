<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"E:\project\tp5\public/../application/admin\view\route_service\ros_index.html";i:1494983978;s:66:"E:\project\tp5\public/../application/admin\view\layout\layout.html";i:1495077108;s:71:"E:\project\tp5\public/../application/admin\view\route_service\form.html";i:1494846626;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <title>ROS管理系统</title>
...
<script>
    (function(){
        ...
        $table.bootstrapTable({
            ...
            columns:[
                {field:'status',title:'是否正常',sortable:true,align:'center',formatter:function(value,row,index){
                    if(value)
                    {
                        return '是';
                    } else {
